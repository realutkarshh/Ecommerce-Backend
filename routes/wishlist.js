...
router.put("/:id", verifyTokenAndAuthorization, wishlistController.updateWishlist);

// DELETE WISHLIST | Method:DELETE /api/wishlist/[wishlistId]
router.delete("/:id", verifyTokenAndAuthorization, wishlistController.deleteWishlist);

// GET USER WISHLIST | Method:GET /api/wishlist/find/[userId]
router.get("/find/:userId", verifyTokenAndAuthorization, wishlistController.getWishlistOfUser);
